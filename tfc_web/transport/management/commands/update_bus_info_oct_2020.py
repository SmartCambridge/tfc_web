...
class Command(BaseCommand):
    ...
    def handle(self, **options):
            ...
            for filename in traveline_zip_file.namelist():
                ...
                try:
                    with traveline_zip_file.open(filename) as xml_file:
                        ...
                        service_code = None # will obtain from content and use to make Route id unique
        ...
        # On successful completion of this processing we move the zip files from tfc_web/data/TNDS_NEW -> TNDS
        for tnds_zone in settings.TNDS_ZONES:
